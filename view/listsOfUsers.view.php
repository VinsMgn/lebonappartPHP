<?php
require_once("../controller/listOfUsers.php");


?><h1> Liste des utilisateurs</h1>
    <button> <a href = "../controller/insertUser.php" style="text-decoration: none; color: black" >Inscription</a></button>
<?php
foreach ($lobjUsers as $lobjUser) {
    ...
    <div>
        ...
        <div>
            Solde : <?php echo($lobjUser->solde); ?>
        </div>
        <div>
            Type : <?php echo($lobjUser->type); ?>
        </div>
        <div>
